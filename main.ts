...
function titleScreen () {
    ...
    music.playMelody("C5 A - A B A G C5 ", 220)
    game.showLongText("Welcome to the Corruption edition of Pac Boy.", DialogLayout.Full)
    game.showLongText("You must find the exit!", DialogLayout.Full)
    game.showLongText("Try and collect as many pebbles as possible", DialogLayout.Full)
    game.showLongText("You only have 60 seconds!", DialogLayout.Full)
    pause(0)
}
...
for (let value of tiles.getTilesByType(assets.tile`myTile0`)) {
    pebble = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.coin)
    tiles.placeOnTile(pebble, value)
